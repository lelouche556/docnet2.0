...
from docnet.forms import MedTestForm
from docnet.models import Account, Action, MedicalTest
...
#         form._errors = {}
#     template_data['form'] = form
#     return render(request, 'docnet/medtest/imgupload.html', template_data)
...
def update_view(request):
    ...
    if request.user.account.role == Account.ACCOUNT_DOCTOR:
        form.disable_field('doctor')
    template_data['form'] = form
    return render(request, 'docnet/medtest/update.html', template_data)