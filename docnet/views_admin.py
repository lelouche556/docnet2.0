...
from docnet.forms import EmployeeRegisterForm
from docnet.models import Account, Profile, Action
...
def activity_view(request):
    ...
    return render(request, 'docnet/admin/activity.html', template_data)
